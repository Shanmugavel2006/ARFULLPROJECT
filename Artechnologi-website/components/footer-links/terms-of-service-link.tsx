...
return ( <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black text-white">
  ...
  <div className="absolute inset-0 z-0">
    <div className="absolute w-[600px] h-[600px] bg-purple-500/20 rounded-full blur-3xl animate-pulse top-[-100px] left-[-100px]" />
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
    ...
    >
      ...
      <p className="text-gray-300 text-lg mb-6 leading-relaxed">
        By accessing and using AR Technology services, you agree to comply
        with the following terms and conditions. Please read them carefully.
      </p>

      <div className="space-y-4 text-gray-400">
        <p>✔ You must use our services responsibly and legally.</p>
        <p>✔ Unauthorized use of our platform is prohibited.</p>
        <p>✔ We reserve the right to update or modify services at any time.</p>
        <p>✔ Your data privacy is protected under our policies.</p>
